...
# This application includes Nx and EXLA directly, so specialize both cores for
# their EXLA frame and audio boundaries.
config :beamicom_nes,
...
config :beamicom_phx, BeamicomPhxWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BeamicomPhxWeb.ErrorHTML, json: BeamicomPhxWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: BeamicomPhx.PubSub,
  live_view: [signing_salt: "5DhRD3rJ"]
