defmodule BeamicomPhxWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :beamicom_phx
  ...
  @session_options [
    store: :cookie,
    key: "_beamicom_phx_key",
    signing_salt: "/AIEixp3",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    only: BeamicomPhxWeb.static_paths(),
