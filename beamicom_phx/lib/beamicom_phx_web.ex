defmodule BeamicomPhxWeb do
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import BeamicomPhxWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias BeamicomPhxWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: BeamicomPhxWeb.Router,
        statics: BeamicomPhxWeb.static_paths()
    end
  end
