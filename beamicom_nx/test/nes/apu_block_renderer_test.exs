defmodule BeamicomNx.NES.APUBlockRendererTest do
  use ExUnit.Case, async: false

  alias Beamicom.NES.APU
  alias BeamicomNx.NES.APUBlockRenderer

  setup do
    previous = Application.get_env(:beamicom, :apu_renderer, :native)
    on_exit(fn -> Application.put_env(:beamicom, :apu_renderer, previous) end)
    :ok
  end
  ...
  test "live frame event capture is exact and survives save-state restore" do
    ...
    Application.put_env(:beamicom, :apu_renderer, :native)
